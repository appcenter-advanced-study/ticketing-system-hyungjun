...
import com.appcenter.wnt.service.kafkaReservationService;
...
@SpringBootTest
@Slf4j
public class KafkaCouponStockTest {
    ...
    @Autowired
    private kafkaReservationService kafkaReservationService;
    ...
    public void 요청100건_중_재고_테스트() throws InterruptedException {
        ...
        for (User user : users) {
            executorService.submit(() -> {
                try {
                    kafkaReservationService.reserve(user.getId(), couponId);
                } catch (Exception e) {
